                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input class="form-control" placeholder="title" name="title" type="text"
                                                   value="{{$brands->title}}" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input class="form-control" placeholder="slug" name="slug" type="text"
                                                   value="{{$brands->slug}}" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <input id="thumbnail" class="thumbnail" type="text" name="photo" value="{{$brands->photo}}">
                                    </div>
                                    <img id="holder" src="{{$brands->photo}}" style="margin-top:15px;max-height:100px;">
                                    <div class="mb-3 row">
...
{{--                                                  value=" {{$banner->Description}}" id="example-search-input"> {{$banner->Description}}</textarea>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="mb-3 row">--}}
...
{{--                                                <option value="banner" {{$banner->conditions=='banner' ? 'selected': ''}}>--}}
{{--                                                    Banner--}}
{{--                                                </option>--}}
{{--                                                <option value="promo"{{$banner->conditions=='promo' ? 'selected': ''}}>--}}
{{--                                                    Promotional Banner--}}
{{--                                                </option>--}}
{{--                                            </select>--}}
{{--                                        </div>--}}
