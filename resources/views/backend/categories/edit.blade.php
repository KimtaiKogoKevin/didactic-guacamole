                            ...
                            <div class="card-body">
                                <form action="{{route("categories.update",$categories->id)}}" method="post">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input class="form-control" placeholder="title" name="title" type="text"
                                                   value="{{$categories->title}}" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <input id="thumbnail" class="thumbnail" type="text" name="photo" value="{{$categories->photo}}">
                                    </div>
                                    <img id="holder" src="{{$categories->photo}}" style="margin-top:15px;max-height:100px;">
                                    <div class="mb-3 row">
                                        ...
                                        <textarea id="description" class="form-control" name="summary" type="text"
                                                  ...
                                                  value="{{$categories->summary}}" id="example-search-input"> {{$categories->summary}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-sm-12 {{$categories->is_parent==1 ? 'd-none' : '' }}" id="parent_cat_div">
                                            ...
                                            <select name="parent_id" class="form-select show-tick">
                                                ...
                                                @foreach($parent_cats as $cats)
                                                    ...
                                                    <option value="{{$cats->id}} {{$cats->id==$categories->parent_id ? 'selected' : ''}}">{{$cats->title}}</option>
                                                @endforeach
