                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">Create a Banner</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route("banner.index")}}">All
                                            Banners </a></li>
                                    <li class="breadcrumb-item active"><a href="{{route("banner.create")}}">
                                            Banners </a></li>
...
{{--                                    <div class="mb-3 row">--}}
{{--                                        <label for="photo" class="col-lg-2 col-sm-2 col-md-2 col-form-label"><h2>--}}
{{--                                                Photo</h2></label>--}}
{{--                                        <input id="thumbnail" class="" type="file" name="photo"--}}
{{--                                               value="{{old("photo")}}">--}}
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <select name="conditions" class="form-select show-tick">
                                                    <option
                                                        value="banner" {{old('conditions')=='banner' ? 'selected': ''}}>
                                                        Banner
                                                    </option>
                                                    <option
                                                        value="promo"{{old('conditions')=='promo' ? 'selected': ''}}>
                                                        Promotional Banner
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                <select name="status" class="form-select show-tick">
                                                    <option value="active" {{old('status')=='active' ? 'checked': ''}}>
                                                        Active
                                                    </option>
                                                    <option
